				...
				<section>
					...
					<form id="contact-form" onSubmit={onFormSubmit} className="mt-3">
						<div className="w-full mb-6 group flex">
							...
							<input
								id="name"
								className="py-1 rounded-l-none focus:outline-none focus:ring-0 focus:border-blue-500 border w-full bg-transparent outline-none pl-1 rounded-r-lg border-gray-600"
						...
						<div className="w-full mb-6 group flex">
							...
							<input
								id="Email"
								className="rounded-l-none focus:outline-none focus:ring-0 focus:border-blue-600 border w-full bg-transparent outline-none pl-1 rounded-r-lg border-gray-600"
