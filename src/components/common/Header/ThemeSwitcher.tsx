...
export default function ThemeSwitcher({ setTheme, theme }: ThemeProps) {
	return (
		<button
			onClick={(event) => Utils.handleTheme(event, setTheme)}
			id="theme-toggle"
			type="button"
		...
		>
			<svg
				...
				viewBox="0 0 512 512"
				className={`fill-sky-500 ${theme === "light" ? "hidden" : ""}`}
				width="21"
				height="21"
			>
