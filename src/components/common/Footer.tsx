    ...
    <footer className="p-4 md:flex md:items-center md:justify-between md:p-6">
      <div className="flex flex-col items-center md:flex-row">
        <button
          onClick={scrollUp}
          aria-labelledby="scrollUp"
          className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-full text-sm p-2 mb-2 md:mb-0"
        >
          <svg
            fill="none"
            height="24"
        ...
        <span className="text-sm text-gray-500 px-1 md:ml-2 mb-2 md:mb-0">
          © {new Date().getFullYear()}{" "}
          <a href="/" className="hover:underline">
            Bi Rong Liu
          </a>
