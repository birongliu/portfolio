  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="flex max-w-fit fixed top-10 dark:bg-primary z-50 bg-white inset-x-0 mx-auto border border-cyan-900 rounded-xl shadow-xl px-5 py-3 items-center justify-center space-x-4"
      >
